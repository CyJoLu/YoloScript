...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str, default=r"C:\Users\86198\Desktop\MD数据\断裂\3.24JPG\3.24JPG",
                        help='image path dir')
    parser.add_argument('--txt-dir', type=str, default=r"C:\Users\86198\Desktop\MD数据\断裂\3.24JPG\labels",
                        help='txt path dir')
    parser.add_argument('--save-dir', default=r"C:\Users\86198\Desktop\MD数据\断裂\3.24JPG\spilt", type=str,
                        help='save dir')
